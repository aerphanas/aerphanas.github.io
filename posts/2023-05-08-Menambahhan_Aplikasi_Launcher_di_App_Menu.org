...
- freedesktop\\
  →
  [[https://specifications.freedesktop.org/desktop-entry-spec/desktop-entry-spec-latest.html#recognized-keys][Desktop
  Entry Specification]]\\
  →
  [[https://specifications.freedesktop.org/menu-spec/latest/apa.html][Registered
  Categories]]
