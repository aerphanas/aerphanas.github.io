...
- RedHat\\
  → [[https://www.redhat.com/sysadmin/compose-podman-pods][Moving from
  docker-compose to Podman pods]]

- Podman\\
  → [[https://docs.podman.io/en/latest/_static/api.html][Podman api
  reference]]

- photo by\\
  → [[https://wallpapercave.com/container-wallpapers][container
  wallpaper]]
