...
- Tom's Development Blog\\
  →
  [[https://tpmullan.com/2021/10/27/chroot-into-an-ubuntu-on-zfs-system/][Chroot
  into an Ubuntu on zfs system]]

- Guix Manual\\
  →
  [[https://guix.gnu.org/en/manual/devel/en/guix.html#Chrooting-into-an-existing-system][Chrooting
...
- MaiZure's Projects\\
  → [[https://www.maizure.org/projects/decoded-gnu-coreutils/][Decoded:
  GNU coreutils]]
