...
- IDAHO STATE UNIVERSITY\\
  → [[https://fsl.fmrib.ox.ac.uk/fslcourse/unix_intro/index.html][A
  Basic UNIX Tutorial]]

- Geeks for Geeks\\
  → [[https://www.geeksforgeeks.org/unix-file-system/][Unix File
  System]]
...
- Bell Laboratories\\
  → [[https://www.bell-labs.com/usr/dmr/www/hist.html][The Evolution of
  the Unix Time-sharing System]]

- WikiPedia Image\\
  →
  [[https://en.wikipedia.org/wiki/Unix_filesystem#/media/File:Standard-unix-filesystem-hierarchy.svg][An
  overview of a Unix filesystem layout, CC BY-SA 4.0]]
