...
karna dilinuk semua hardware dianggap sebagai folder atau file, maka
...
setelah itu kita mindapat kan sebiah prom interaktif, silakan ketik =m=
...
- Linux Source code\\
  →
  [[https://www.tuhs.org/cgi-bin/utree.pl?file=Linux0.96c/include/linux/ext_fs.h][Linux
  v0.96c]]

- ext2fsprogs\\
  → [[https://e2fsprogs.sourceforge.net/ext2intro.html][Design and
  Implementation of the Second Extended Filesystem]]\\
  → [[https://e2fsprogs.sourceforge.net/journal-design.pdf][Journaling
